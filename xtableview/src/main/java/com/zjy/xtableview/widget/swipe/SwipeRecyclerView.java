...
import com.zjy.xtableview.widget.swipe.touch.DefaultItemTouchHelper;
import com.zjy.xtableview.widget.swipe.touch.OnItemMoveListener;
import com.zjy.xtableview.widget.swipe.touch.OnItemMovementListener;
import com.zjy.xtableview.widget.swipe.touch.OnItemStateChangedListener;
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN: {
                    ...
                    if (touchPosition != mOldTouchedPosition && mOldSwipedLayout != null &&
                            mOldSwipedLayout.isMenuOpen() || (mOldSwipedLayout != null && !mOldSwipedLayout.isScrollFinish())) {
                        mOldSwipedLayout.smoothCloseMenu();
                        isIntercepted = true;
                    }
